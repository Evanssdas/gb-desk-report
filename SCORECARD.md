...
_Auto-generated 2026-08-10. Live, forward, out-of-sample. Not a backtest._
...
|---|---|---|
| **Model** | 36.34 | 40.27 |
| Benchmark: yesterday's price | 14.65 | 18.80 |
| Benchmark: 7-day average | 11.91 | 15.79 |
| Benchmark: same day last week | 15.60 | 21.77 |

**Directional accuracy:** 48% (did we call up/down correctly vs yesterday, over 29 days)

**Bias:** -36.34 £/MWh (under-forecasting)

**Verdict:** the model does NOT beat the persistence benchmark on MAE.

## B. Signal performance (does acting on it pay?)

Signal frequency: **0** LONG/SHORT, **19** FLAT (no trade)
