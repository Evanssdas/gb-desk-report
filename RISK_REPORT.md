# Daily Risk Report
_Generated 2026-07-17 - GB day-ahead power. Auto-updated daily._

## Market conditions

| metric | value |
|---|---|
| spot (last daily peak) | £129.07/MWh |
| 30-day daily volatility | **47.2%** |
| 90-day daily volatility | 28.7% |
...
|---|---|---|---|---|---|
| GB power DA (reference) | long | 100 | 12,907 | 10,059 | 14,204 |
| **PORTFOLIO** | | | **12,907** | **10,059** | **14,204** |

Interpretation: on roughly 1 day in 20, a loss of at least **£10,059** would be expected.
...
| max portfolio VaR (95%) | £15,000 | £10,059 | OK |

## Position sizing at current volatility

At **47.2%** daily volatility and a £15,000 VaR limit, the largest permissible position is:
