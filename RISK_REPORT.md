# Daily Risk Report
_Generated 2026-09-23 - GB day-ahead power. Auto-updated daily._

## Market conditions

| metric | value |
|---|---|
| spot (last daily peak) | £152.39/MWh |
| 30-day daily volatility | **16.2%** |
...
|---|---|---|---|---|---|
| GB power DA (reference) | long | 100 | 15,239 | 4,074 | 5,752 |
| **PORTFOLIO** | | | **15,239** | **4,074** | **5,752** |

Interpretation: on roughly 1 day in 20, a loss of at least **£4,074** would be expected.
...
| max portfolio VaR (95%) | £15,000 | £4,074 | OK |

## Position sizing at current volatility

At **16.2%** daily volatility and a £15,000 VaR limit, the largest permissible position is:
