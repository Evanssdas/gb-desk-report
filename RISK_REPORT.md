# Daily Risk Report
_Generated 2026-07-16 - GB day-ahead power. Auto-updated daily._

## Market conditions

| metric | value |
|---|---|
| spot (last daily peak) | £123.54/MWh |
| 30-day daily volatility | **46.9%** |
...
|---|---|---|---|---|---|
| GB power DA (reference) | long | 100 | 12,354 | 9,566 | 13,509 |
| **PORTFOLIO** | | | **12,354** | **9,566** | **13,509** |

Interpretation: on roughly 1 day in 20, a loss of at least **£9,566** would be expected.
...
| max portfolio VaR (95%) | £15,000 | £9,566 | OK |

## Position sizing at current volatility

At **46.9%** daily volatility and a £15,000 VaR limit, the largest permissible position is:
