# Daily Risk Report
_Generated 2026-09-19 - GB day-ahead power. Auto-updated daily._

## Market conditions

| metric | value |
|---|---|
| spot (last daily peak) | £-2.04/MWh |
| 30-day daily volatility | **21.9%** |
| 90-day daily volatility | 29.6% |
| 90-day range | £-2 - £561/MWh |
| worst single-day move (90d) | -101.2% |
...
|---|---|---|---|---|---|
| GB power DA (reference) | long | 100 | -204 | 74 | 104 |
| **PORTFOLIO** | | | **-204** | **74** | **104** |

Interpretation: on roughly 1 day in 20, a loss of at least **£74** would be expected.
...
Note: the worst single day in the last 90 was **-101.2%**, so the larger shocks above are not hypothetical.
...
| max portfolio VaR (95%) | £15,000 | £74 | OK |

## Position sizing at current volatility

At **21.9%** daily volatility and a £15,000 VaR limit, the largest permissible position is:
